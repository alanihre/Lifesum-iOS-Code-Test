...
- (void)strokeChart
{
    ...
    //[_countingLabel countFrom:0 to:[_current floatValue]/([_total floatValue]/100.0)];
    float labelValue = [_current floatValue]/([_total floatValue]/100.0);
    _countingLabel.text = [NSString stringWithFormat:@"%0.f%%", labelValue];
